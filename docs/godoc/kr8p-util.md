...
## func [CalculateClusterIncludesExcludes](<https://github.com:icebergtech/kr8p/blob/main/pkg/util/util.go#L127>)
...
## func [CheckObjectMatch](<https://github.com:icebergtech/kr8p/blob/main/pkg/util/util.go#L55>)
...
## func [CleanOutputDir](<https://github.com:icebergtech/kr8p/blob/main/pkg/util/directories.go#L111>)
...
<a name="Colorize"></a>
## func [Colorize](<https://github.com:icebergtech/kr8p/blob/main/pkg/util/json.go#L42>)
...
## func [FatalErrorCheck](<https://github.com:icebergtech/kr8p/blob/main/pkg/util/util.go#L109>)
...
## func [FetchRepoUrl](<https://github.com:icebergtech/kr8p/blob/main/pkg/util/remote.go#L13>)
...
<a name="Filter"></a>
## func [Filter](<https://github.com:icebergtech/kr8p/blob/main/pkg/util/util.go#L15>)
...
## func [FilterItems](<https://github.com:icebergtech/kr8p/blob/main/pkg/util/util.go#L75>)
...
## func [FormatJsonnetString](<https://github.com:icebergtech/kr8p/blob/main/pkg/util/json.go#L108>)
...
## func [FormatJsonnetStringCustom](<https://github.com:icebergtech/kr8p/blob/main/pkg/util/json.go#L113>)
...
## func [GenErrorIfCheck](<https://github.com:icebergtech/kr8p/blob/main/pkg/util/util.go#L115>)
...
## func [GetClusterFilenames](<https://github.com:icebergtech/kr8p/blob/main/pkg/util/directories.go#L16>)
...
## func [GetClusterParamsFilenames](<https://github.com:icebergtech/kr8p/blob/main/pkg/util/directories.go#L72>)
...
## func [GetClusterPaths](<https://github.com:icebergtech/kr8p/blob/main/pkg/util/directories.go#L46>)
...
## func [GetDefaultFormatOptions](<https://github.com:icebergtech/kr8p/blob/main/pkg/util/json.go#L90>)
...
## func [JsonnetPrint](<https://github.com:icebergtech/kr8p/blob/main/pkg/util/json.go#L55>)
...
<a name="Pretty"></a>
## func [Pretty](<https://github.com:icebergtech/kr8p/blob/main/pkg/util/json.go#L18>)
...
## func [WriteObjToJsonFile](<https://github.com:icebergtech/kr8p/blob/main/pkg/util/json.go#L120>)
...
## type [PathFilterOptions](<https://github.com:icebergtech/kr8p/blob/main/pkg/util/util.go#L27-L51>)
