...
<img src="./docs/kr8p_gopher.png" alt="kr8+ Gopher" width="400" align="right" >
...
![kr8+ workflow](./docs/diagram/kr8p-workflow.png)
...
Cluster Spec: [types.Kr8ClusterJsonnet](./docs/godoc/kr8p-types.md#Kr8pClusterJsonnet)
...
Component Spec: [types.Kr8ComponentJsonnet](./docs/godoc/kr8p-types.md#Kr8pComponentJsonnet)
