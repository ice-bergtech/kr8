...
Cluster Spec: [types.Kr8ClusterJsonnet](./docs/godoc/kr8p-types.md#Kr8ClusterJsonnet)
...
Component Spec: [types.Kr8ComponentJsonnet](./docs/godoc/kr8p-types.md#Kr8ComponentJsonnet)
